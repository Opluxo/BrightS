...
static char version[20] = "v0.1.3.1";
...
static void print_system_info(void)
{
  ...
  brights_serial_write_ascii(BRIGHTS_COM1_PORT, "  \033[1;33mSystem:\033[0m \033[1;37mBrightS v0.1.3.1\033[0m\r\n");
...
static void login_draw_fb(int attempts, const char *error_msg)
{
  ...
  /* Title */
  const char *title = "BrightS v0.1.3.1";
...
#define LOGIN_VERT 7
  ...
  for (;;) {
...

    {
      ...
      brights_serial_write_ascii(BRIGHTS_COM1_PORT, "+---------------------------------------------+\r\n");
      for (p = 0; p < LOGIN_PAD; ++p) brights_serial_write_ascii(BRIGHTS_COM1_PORT, " ");
      brights_serial_write_ascii(BRIGHTS_COM1_PORT, "|              BrightS v0.1.3.1               |\r\n");
      for (p = 0; p < LOGIN_PAD; ++p) brights_serial_write_ascii(BRIGHTS_COM1_PORT, " ");
...
void brights_lightshell_run(void)
{
  ...
  if (brights_fb_available()) {
    ...
    title_right[ti] = 0;
    tui_draw_title_bar("BrightS v0.1.3.1", title_right);
