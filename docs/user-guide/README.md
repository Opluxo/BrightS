...
- [Command Reference](COMMAND_REFERENCE.md) — EN
- [Command Reference (中文)](COMMAND_REFERENCE_CN.md) — CN
- [Command Reference (日本語)](COMMAND_REFERENCE_ja.md) — JA
...
- `help` — general help | 通用帮助 | 一般的なヘルプ
- `help <command>` — command-specific help | 特定命令帮助 | 特定コマンドのヘルプ
- `bspm --help` — BSPM help | BSPM帮助 | BSPMのヘルプ
